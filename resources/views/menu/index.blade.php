...
@section('content')
                    ...
                    <div class="modal-body">
                        <form action="{{ route('menu.editmenu_action', $menu->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="icon_menu" value="{{ $menu->icon_menu }}" class="form-control"
                                    required>
                            </div>
    ...
    <!-- Modal Delete -->
    @foreach ($menus as $menu)
        <div class="modal fade" id="delete{{ $menu->id }}" tabindex="-1" role="dialog"
