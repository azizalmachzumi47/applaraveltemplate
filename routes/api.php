...
Route::group(['prefix' => 'datamhs'], function () {
    ...
    Route::post('delete-by-checklist', [Datamhs_apiController::class, 'deleteByChecklist']);
    Route::post('show-selected', [Datamhs_apiController::class, 'showSelected']);
    Route::put('update-by-checklist', [Datamhs_apiController::class, 'updateByChecklist']);
